    ...
    <nav class=" bg-white px-2 sm:px-4 py-2.5 dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200">
        <div class="container flex flex-wrap items-center justify-between mx-auto">
            <a href="{{ route('pages.home') }}" class="flex items-center">
                ...
                <span class="self-center text-xl font-semibold whitespace-nowrap text-dark-400"><b class="text-teal-600">Jane</b>HO</span>
            </a>
            <div class="flex md:order-2">
                <button type="button" class="text-white bg-teal-600 hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 "><a href={{ route('pages.sign_up') }}>Sign Up</a></button>
                ...
                <ul class="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white">
                    ...
                    <li>
                        <a href="{{ route('buses.index') }}"
                            class="block py-2 pl-3 pr-4 {{ Route::currentRouteName() == 'buses.buses' ? 'text-teal-500' : 'text-gray-700' }} rounded hover:bg-gray-100 md:hover:bg-transparent">Buses</a>
                    </li>
                    <li>
