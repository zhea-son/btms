              ...
              <div class="flex flex-col w-full max-w-full px-3 mx-auto lg:mx-0 shrink-0 md:flex-0 md:w-7/12 lg:w-5/12 xl:w-4/12">
                <div class="relative flex flex-col min-w-0 break-words bg-transparent border-0 shadow-none lg:py4 dark:bg-gray-950 rounded-2xl bg-clip-border">
                  <div class="p-6 pb-0 mb-0">
                    ...
                    <p class="mb-0">Enter your contact for Bus</p>
                  </div>
                  <div class="flex-auto p-6">
                    <form action={{ route('bus.authenticate') }} method="post">
                        @csrf
                      <div class="mb-4">
                        <input name="contact" type="text" placeholder="Bus Contact" class="focus:shadow-primary-outline dark:bg-gray-950 dark:placeholder:text-white/80 dark:text-white/80 text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding p-3 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" />
                      </div>
                      <div class="mb-4">
                  ...
                  {{-- <div class="border-black/12.5 rounded-b-2xl border-t-0 border-solid p-6 text-center pt-0 px-1 sm:px-6">
                    <p class="mx-auto mb-6 leading-normal text-sm">Don't have an account? <a href="{{ route('company.signup') }}" class="font-semibold text-transparent bg-clip-text bg-gradient-to-tl from-blue-500 to-violet-500">Sign up</a></p>
                  </div> --}}
                </div>
              </div>
      ...
      <div class="container">
        <div class="flex flex-wrap -mx-3">
          <div class="flex-shrink-0 w-full max-w-full mx-auto mb-6 text-center lg:flex-0 lg:w-8/12">
            <a href="/" target="_blank" class="mb-2 mr-4 text-slate-400 sm:mb-0 xl:mr-12"> Home </a>
            <a href="/user/login" target="_blank" class="mb-2 mr-4 text-slate-400 sm:mb-0 xl:mr-12"> User </a>
            <a href="/about" target="_blank" class="mb-2 mr-4 text-slate-400 sm:mb-0 xl:mr-12"> About </a>
            <a href="/buses;" target="_blank" class="mb-2 mr-4 text-slate-400 sm:mb-0 xl:mr-12"> Buses </a>
            <a href="javascript:;" target="_blank" class="mb-2 mr-4 text-slate-400 sm:mb-0 xl:mr-12"> Routes </a>
            <a href="javascript:;" target="_blank" class="mb-2 mr-4 text-slate-400 sm:mb-0 xl:mr-12"> Schedules </a>
          </div>
