...
<h1 class="text-center text-4xl text-bold text-teal-500">Add a Bus</h1><!-- component -->
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="/buses" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="border-2 border-gray-300 p-2 w-full" name="number_plate" id="number_plate" placeholder="Eg:Ba-Pra-02-022-Pa-9181" value="{{old('number_plate')}}" required>
                            @error('title')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="border-2 border-gray-300 p-2 w-full" name="seats" id="seats" value="{{old('seats')}}">
                            @error('seats')
                            <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                            @enderror
                        </div>
